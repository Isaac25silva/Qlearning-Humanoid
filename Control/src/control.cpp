...
float posAccel[31] = {-0.870, -0.875, -0.880, -0.885, -0.890, -0.895, -0.900, -0.905, -0.910, -0.915,
		   -0.920, -0.925, -0.930, -0.935, -0.940, -0.945, -0.950, -0.955, -0.960, -0.965,
		   -0.970, -0.975, -0.980, -0.985, -0.990, -0.995, -1.000, -1.005, -1.010, -1.0150, -1.020};
...
void saveTime(unsigned int Episodio, unsigned int tempo)
{
    ...
    File.open("Tempo.dat", std::ios::app | std::ios::out);
    if (File.good() && File.is_open())
    {
        File << Episodio <<" "<< tempo;
        File << std::endl;
